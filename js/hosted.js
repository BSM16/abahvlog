! function(h, n) {
  ...
  function F() {
    ...
    if (n) {
      ...
      var a = e.firstChild;
      window.disqus_blogger_current_url = "https://abahvlog.blogspot.com" + window.location.pathname, p = function() {
        var e, t;
  ...
  window.disqus_shortname = "abahvlog", window.disqus_blogger_current_url = "http://abahvlog.blogspot.com" + window.location.pathname, window.disqus_blogger_homepage_url = "http://abahvlog.blogspot.com/", window.disqus_blogger_canonical_homepage_url = "http://abahvlog.blogspot.com/", window.console.log = window.console.info = void 0;
  var p = null,
    l, k, m, A, f, r, H, I, J, t;
  "abahvlog.blogspot.com" != window.location.host && -1 == window.location.host.indexOf("abahvlog.blogspot") && -1 == window.location.host.indexOf("8200568266150379059_a6d5510549403daf1f0f26b2e52c6f2977055029") && (window.location.href = "https://abahvlog.blogspot.com/"), NodeList.prototype.forEach = function(t) {
    ...
    }, l.ga.l = 1 * new Date, m = k.createElement("script"), A = k.getElementsByTagName("script")[0], m.async = 1, m.src = "https://www.google-analytics.com/analytics.js", A.parentNode.insertBefore(m, A), ga("create", "#", "auto"), ga("send", "pageview"), f = document.querySelector("#a .a"), r = f.querySelector("#c input"), H = f.getElementsByClassName("e-button")[0], I = f.getElementsByClassName("a-button")[0], J = f.offsetTop, window.addEventListener("scroll", function() {
